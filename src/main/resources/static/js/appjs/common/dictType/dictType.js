...
function remove1(typeId) {
	layer.confirm('确定要删除选中的记录？', {
		btn:[ '确定', '取消' ]
	}, function() {
		$.post(prefix + "/remove",{'typeId':typeId},function(r) {
				if (r.code == 0) {
					layer.msg(r.msg);
					$("#reload").click();
				} else {
